namespace BydTools.Wwise.Ww2ogg.Extensions;
...
internal static class BinaryReaderExtensions
{
    ...
    internal static void seekg(this BinaryReader reader, int position) =>
        reader.seekg(position, StreamPosition.Beginning);
